...
### Low budget frontend (static html frontend)
A low budget frontend használható teljes funkcionalitással. Ez statikus html + js + css, nem igényel külön szervert. Böngészőben elég megnyitni az index.html -t.
